...
- **GitHub Security Advisories** — [open a private report](https://github.com/semitexa/platform-settings/security/advisories/new).
...
- **Email** — `support@semitexa.com`. Put "security" and the package name
  (`semitexa/platform-settings`) in the subject.
...
In scope: anything in `semitexa/platform-settings` that lets a request, a job or a message do
